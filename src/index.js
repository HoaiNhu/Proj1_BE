...
const ALLOWED_ORIGINS = (
  ...
  "https://avocado-app.onrender.com,http://localhost:3000,http://localhost:3100,http://localhost:8000,https://rcm-system.onrender.com,https://fe-project-avocado-cake.vercel.app"
)
  .split(",")
  .map((s) => s.trim());
